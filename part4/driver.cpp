...
// Note: Used AI assistance to help implement the symbol table printing
// and Cymerica banner, but teacher said I could as long as I cite
// =============================================================================
#include <cstdio>
#include <cstring>
#include <iostream>
...
// Cymerica startup header
void cymericaHeader()
{
    cout << C_RED <<
    "   ______                           _           \n"
    "  / ____/_  ______ ___  ___  _____ (_)________ _\n"
    " / /   / / / / __ `__ \\/ _ \\/ ___// / ___/ __ `/\n"
    "/ /___/ /_/ / / / / / /  __/ /   / / /__/ /_/ / \n"
    "\\____/\\__, /_/ /_/ /_/\\___/_/   /_/\\___/\\__,_/  \n"
    "      /____/                                     \n"
    << C_RESET;
    cout << C_BOLD << "  Cymerica Language Interpreter  |  Part 4: Truth, Logic & Control Flow\n"
         << "  MSU CSE 4714  |  Spring 2026\n" << C_RESET << "\n";
}
...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        if (FLAG_SYMBOLS) {
            ...
            banner("That's All Folks!", C_CYAN);
        }
